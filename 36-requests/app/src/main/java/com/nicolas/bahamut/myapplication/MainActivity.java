package com.nicolas.bahamut.myapplication;
...
import com.nicolas.bahamut.myapplication.api.CEPService;
...
import com.nicolas.bahamut.myapplication.api.DataService;
import com.nicolas.bahamut.myapplication.model.Postagem;
    ...
    public void recuperarCepRetrofit() {
        ...
        call.enqueue(new Callback<CEP>() {
            ...
            public void onResponse(Call<CEP> call, Response<CEP> response) {
                ...
                textoResultado.setText(cep.getLocalidade() + '/' + cep.getLogradouro());
            }
